...
<Container>
   ...
   <h5 className="modal-title">Withdraw ID#  <span>TNX93665676</span></h5>
   ...
   <div className="mb-3">
   <p>User <b>(UID08124)</b> request to withdraw <b>50.00 USD</b> via <b>PayPal.</b> Please check out the details and send payment to user account below.</p>
   </div>
    ...
    <table class="table table-plain table-borderless table-sm mb-0 withdrawTable">
        <tbody>
            <tr>
                ...
                <td>
                    <span class="lead-text">50.00 USD</span> 
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td><span class="sub-text">Withdraw Account</span></td>
                <td><span class="lead-text">AC-8124-2843</span></td>
            </tr>
            <tr>
                <td><span class="sub-text">Payment Information</span></td>
                <td>
                    <div class="label lead-text">Email Address / PayPal</div>
                    <div class="data mb-1">nnaemekachurchilld@gmail.com</div>
                    <div class="label lead-text">Account No / ID</div>
                    <div class="data mb-1">nnaemekachurchilld@gmail.com</div>
                    <div class="label lead-text">Account Currency</div>
                    <div class="data mb-1">US Dollar (USD)</div>
                </td>
            </tr>
            <tr>
      ...
      <div className="modal-dialog modal-sm modal-dialog-centered" role="document">
         <div className="modal-content">
            ...
            <div className="modal-body text-center py-4">
               <svg xmlns="http://www.w3.org/2000/svg" className="icon mb-2 icon-lg" style={{ color: '#1a48aa' }} width={24} height={24} viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
