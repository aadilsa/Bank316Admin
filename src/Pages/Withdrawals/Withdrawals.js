                                                                ...
                                                                <div className="nk-tb-item" key={data.id}>
                                                                            ...
                                                                            <div className="user-card" >
                                                                                {
                                                                                    ...
                                                                                    <div className="user-info " style={{ cursor: "pointer", }} onClick={() => GoToUserDetail(data?.transaction?.client_id)}>
                                                                                        <span className="tb-lead " ><span style={{ textTransform: "capitalize" }}>{data?.transaction?.recipient_name} </span>
                                                                    ...
                                                                    <div className="nk-tb-col tb-col-lg">
                                                                        <a >
                                                                            <div className="user-card" >
                                                                                {
                                                                                    data?.transaction?.txn_id == null ? <div className="user-info">
                                                                                        ...
                                                                                        <span className="tb-lead text-primary" ><span onClick={() => { GoAllreqTxn(data.transaction?.id) }}>{data.transaction?.txn_id}</span><span><CopyToClipboard text={data?.transaction?.txn_id} style={{ height: '25px', width: '25px', padding: 2 }} >
                                                                    ...
                                                                    <div className="nk-tb-col tb-col-lg">
                                                                        <ul className="list-status">
                                                                            {
                                                                                data?.transaction?.base_amount == null ? <li> <span>N/A</span></li> : <li> <span >{data?.other_currency_symbol} {data?.transaction?.base_amount}</span></li>
                                                                            }
                                                                    ...
                                                                    <div className="nk-tb-col tb-col-lg">
                                                                        <ul className="list-status">
                                                                            {
                                                                                data?.transaction?.payment_status == "pending" && <span className="badge badge-sm badge-dot has-bg bg-warning d-none d-sm-inline-flex">Pending</span>
                                                                            }
                                                                            {
                                                                                data?.transaction?.payment_status == "success" && <span className="badge badge-sm badge-dot has-bg bg-success d-none d-sm-inline-flex">Completed</span>
                                                                            }
                                                                            {
                                                                                data?.transaction?.payment_status == "failed" && <span className="badge badge-sm badge-dot has-bg bg-danger d-none d-sm-inline-flex">Rejected</span>
                                                                            }
                                                                        </ul>
                                                                    </div>
                                                                    ...
                                                                    <div className="nk-tb-col">
                                                                        <ul onClick={() => reqmoneystatus(data)}>
                                                                            {
                                                                                data?.transaction?.payment_status == "pending" && <button className="btn btn-primary" style={{ padding: "4px 15px", fontSize: "12px" }} data-bs-toggle="modal" data-bs-target="#modal-report"  ><span>Process</span></button>
                                                                            }
                                                                            {
                                                                                data?.transaction?.payment_status == "success" && <button className="btn btn-primary" style={{ padding: "4px 15px", fontSize: "12px" }} data-bs-toggle="modal" data-bs-target="#modal-report" disabled><span>Process</span></button>
                                                                            }
                                                                            {
                                                                                data?.transaction?.payment_status == "failed" && <button className="btn btn-primary" style={{ padding: "4px 15px", fontSize: "12px" }} data-bs-toggle="modal" data-bs-target="#modal-report" disabled><span>Process</span></button>
                                                                            }
                                                                        </ul>
                                                                    </div>
