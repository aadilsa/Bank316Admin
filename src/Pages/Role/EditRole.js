...
import { AddRoles, GetRoledatatitle } from '../../API/RoleApi/Role';
...
export default function EditRole() {
    ...
    const RoleDatabyId = async () => {
        try {
            ...
            if (resp.status == true) {
                ...
                console.log(JSON.parse(resp.data.permission), "}}}}}{{{{{{{}}{}{}{}{}")
    ...
    // if (permission.constructor.name == "Object") {
    //     let emptarray = []
    //     for (let i in permission) {
    //         emptarray.push(permission[i])
    //     }
    //     permission = emptarray
    // }


    console.log(permission, "this is permission  data")
    console.log(employeeData, "this is employeedata data")
    ...
    const updateEmployeeData = (e, key) => {
        ...
        setEmployeeData((prevData) => {
            if (isChecked) {
                return [...prevData, { value: checkboxValue, key }];
            } else {
    ...
    useEffect(() => {
        permission?.map((options) => {
            ...
            if (options.key == "Add_curency") {
                roles.Add_curency = true;
            }
                                                                ...
                                                                <div className="row" style={{ padding: "2rem" }}>
                                                                        ...
                                                                        <div className="custom-controls-stacked d-flex mb-3">
                                                                            ...
                                                                            <label className="custom-control custom-checkbox diclamerpage" style={{ display: 'inline-flex', minHeight: '1.5rem', marginRight: '30px', }}>
                                                                                {roles.get_all_clients == true ? <input type="checkbox" defaultChecked={true} className="custom-control-input NewCHeckBx" value="true"
                                                                                    onClick={(e) => updateEmployeeData(e, "get_all_clients")}
                                                                                /> :
                                                                    ...
                                                                    <div className="row mb-3">
                                                                        ...
                                                                        <div className="custom-controls-stacked d-flex mb-3">
                                                                            ...
                                                                            <label className="custom-control custom-checkbox diclamerpage" style={{ display: 'inline-flex', minHeight: '1.5rem', marginRight: '30px', }}>
                                                                                {
                                                                                    roles.Add_curency == true ? <input type="checkbox" defaultChecked={true} className="custom-control-input NewCHeckBx" value="true"
                                                                                        onClick={(e) => updateEmployeeData(e, "Add_curency")}
                                                                                    /> : <input type="checkbox" className="custom-control-input NewCHeckBx" value="true"
                                                                                        onClick={(e) => updateEmployeeData(e, "Add_curency")}
                                                                                    />
                                                                                }
