...
import { GetTotalBankdata } from '../../API/BankListApi/BankList';
...
const BankList = () => {
    ...
    const GetBankList = async () => {
        try {
            const totaldata = await GetTotalBankdata(token)
            console.log(totaldata.data.rows, "totaldata")
                                ...
                                <div className="nk-block-head nk-block-head-sm">
                                    <div className="nk-block-between">
                                        <div className="nk-block-head-content">
                                            {/* <h3 className="nk-block-title page-title">Bank Lists</h3> */}
                                            <h5>Bank Lists</h5>
                                            <div className="nk-block-des text-soft">
                                                <p>You have total {total} Customers.</p>
                                            </div>
                                                ...
                                                <div className="card-title-group">
                                                    ...
                                                    <div className="card-tools me-n1">
                                                        <ul className="btn-toolbar gx-1">
                                                            <li>
                                                                <a className="btn btn-icon search-toggle toggle-search" data-target="search"><em className="icon ni ni-search" onChange={(e) => { setsearch(e.target.value) }} /></a>
                                                            </li>{/* li */}
                                                ...
                                                <div className="card-search search-wrap" data-search="search" >
                                                    <div className="card-body">
                                                        <div className="search-content">
                                                            ...
                                                            <input type="text" className="form-control border-transparent form-focus-none" placeholder="Search by user or email" onChange={(e) => { setsearch(e.target.value) }} />
                                            ...
                                            <div className="card-inner p-0">
                                                <div className="nk-tb-list nk-tb-ulist">
                                                    <div className="nk-tb-item nk-tb-head">
                                                        ...
                                                        <div className="nk-tb-col"><span className="sub-text">Bank Name</span></div>
                                                        <div className="nk-tb-col tb-col-lg"><span className="sub-text">Bank Name</span></div>
                                                                    ...
                                                                    <ul className="link-tidy sm no-bdr">
                                                                        ...
                                                                        <li>
                                                                            <div className="custom-control custom-control-sm custom-checkbox">
                                                                                ...
                                                                                <label className="custom-control-label" htmlFor="vri">Bank Name</label>
                                                                            </div>
                                                                        </li>
                                                                        <li>
                                                                            <div className="custom-control custom-control-sm custom-checkbox">
                                                                ...
                                                                <div className="nk-tb-item" key={data.id}>
                                                                        ...
                                                                        <a >
                                                                            <div className="user-card">
                                                                                <div className="user-avatar bg-primary">
                                                                                    <span><Image src={data.bank_image} alt='img' /></span>
                                                                                </div>
                                                                            </div>
                                                                        </a>
                                                                    </div>
                                                                    ...
                                                                    <div className="nk-tb-col tb-col-lg">
                                                                        <ul className="list-status">
                                                                            {
                                                                                data.bank_name == null ? <li> <span>N/A</span></li> : <li> <span>{data.bank_name}</span></li>
