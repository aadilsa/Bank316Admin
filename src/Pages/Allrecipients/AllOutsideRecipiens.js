...
import { GetAlloutesideRecipientData } from '../../API/AllRecipientsApi/AllRecipientsAPI';
export const AllOutsideRecipiens = () => {
    ...
    const AlloutesideRecipientData = async () => {
        try {
            const totaldata = await GetAlloutesideRecipientData(token, sortedBy, orderBy, search, pageNumber)
                                            ...
                                            <>
...

                                                {
                                                    data.length > 0 && data.map((data) => {
                                                        ...
                                                        var timeZones = moment(stillUtcs).local().format('YYYY-MM-DD ');
                                                        return (
                                                            <>
                                                                <div className="nk-tb-item">
                                                                    <div className="nk-tb-col">
