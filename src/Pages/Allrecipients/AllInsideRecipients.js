...
import { GetAllinsideRecipientsData } from '../../API/AllRecipientsApi/AllRecipientsAPI';

export const AllInsideRecipients = () => {
    ...
    const AllinsideRecipientData = async () => {
        try {
            const totaldata = await GetAllinsideRecipientsData(token, sortedBy, orderBy, search, pageNumber)
                            ...
                            <div className="nk-block-head nk-block-head-sm">
                                <div className="nk-block-between">
                                    <div className="nk-block-head-content">
                                        <h5>Recipients ( Bank316 User )</h5>
                                        <div className="nk-block-des text-soft">
                                            <p>You have total <span className='fw-bold'>({count})</span> Bank316 User.</p>
                                        </div>
                                                ...
                                                <ul className="nk-block-tools g-3">
                                                    ...
                                                    <li>
                                                        <div className="form-control-wrap">
                                                            ...
                                                            <input type="text" className="form-control" placeholder="Quick search by email" onChange={(e) => { setsearch(e.target.value); setPagenumber(1) }} />
                                                        </div>
                                                    </li>
                            ...
                            <div className="nk-block">
                                <div className="nk-tb-list is-separate is-medium mb-3">
                                    <div className="nk-tb-item nk-tb-head">
                                        <div className="nk-tb-col fw-bold"><span>Email  {sortedBy == "email" && orderBy === "desc" ? <em className="icon ni ni-arrow-down" style={{ cursor: 'pointer' }} onClick={() => { sortChange("email") }} /> : <em className="icon ni ni-arrow-up" style={{ cursor: 'pointer' }} onClick={() => { sortChange("email") }} />}</span></div>
                                        <div className="nk-tb-col tb-col-sm fw-bold"><span>Phone {sortedBy == "phone" && orderBy === "desc" ? <em className="icon ni ni-arrow-down" style={{ cursor: 'pointer' }} onClick={() => { sortChange("phone") }} /> : <em className="icon ni ni-arrow-up" style={{ cursor: 'pointer' }} onClick={() => { sortChange("phone") }} />}</span></div>
                                                                ...
                                                                <div className="nk-tb-item">
                                                                    <div className="nk-tb-col">
                                                                        <div class="user-card">
                                                                            ...
                                                                            >
                                                                                <span class="tb-lead" style={{ textTransform: "capitalize" }}>{data?.email} <span class="dot dot-success d-md-none ms-1"></span></span>
                                                                    ...
                                                                    <div className="nk-tb-col tb-col-sm">
                                                                        <span className="tb-sub text-black"> <span>{data?.phone}</span> </span><br></br>
                                                                    </div>

                                                                    <div className="nk-tb-col tb-col-sm">
                                                                        {
                                                                            data?.created_at == null ? <span className="tb-sub">N/A</span> : <span className="tb-sub" style={{ textTransform: "capitalize" }}> {timeZones}</span>
                                                                        }
                                                                    </div>
                                                                                    ...
                                                                                    <div className="dropdown-menu dropdown-menu-end">
                                                                                        <ul className="link-list-opt no-bdr">
                                                                                            <li
                                                                                                //client idddddd
                                                                                                onClick={() => Custmerdetails(data?.other_client_id)}
                                                                                                style={{ cursor: "pointer" }} ><a ><em className="icon ni ni-eye" /><span>View Details</span></a></li>
