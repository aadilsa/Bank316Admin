...
import { GetLavelInvestdata } from '../../API/LavelApi/Lavel';

const LavelInvest = () => {
    const [data, setdata] = useState([])
    const [total, settotal] = useState()
    const token = localStorage.getItem("logintoken")
    const GetLavelData = async () => {
        try {
            const totaldata = await GetLavelInvestdata(token)
            console.log(totaldata.data.rows, "total data")
                                ...
                                <div className="nk-block-head nk-block-head-sm">
                                    <div className="nk-block-between">
                                        <div className="nk-block-head-content">
                                            <h3 className="nk-block-title page-title">Level for Investment</h3>
                                            <div className="nk-block-des text-soft">
                                                <p>You have total {total}  Level for Investment Data.</p>
                                            </div>
                                            ...
                                            <div className="card-inner p-0">
                                                <div className="nk-tb-list nk-tb-ulist">
                                                    <div className="nk-tb-item nk-tb-head">
                                                        ...
                                                        <div className="nk-tb-col"><span className="sub-text">Level Name</span></div>
                                                        <div className="nk-tb-col tb-col-mb"><span className="sub-text">Currency</span></div>



                                                        <div className="nk-tb-col tb-col-md"><span className="sub-text">Min Amount</span></div>
                                                        <div className="nk-tb-col tb-col-md"><span className="sub-text">Max Amount</span></div>
                                                                        ...
                                                                        <div className="nk-tb-col">
                                                                            <div className="user-card">
                                                                                ...
                                                                                <div className="user-info">
                                                                                    <span className="tb-lead">{data.level_name} <span className="dot dot-warning d-md-none ms-1" /></span>

                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div className="nk-tb-col tb-col-mb">
                                                                            <span className="tb-amount">{data.currency}<span className="currency"></span></span>
                                                                        </div>



                                                                        <div className="nk-tb-col tb-col-md">
                                                                            <span className="tb-status">{data.min_amount}</span>
                                                                        </div>

                                                                        <div className="nk-tb-col tb-col-md">
                                                                            <span className="tb-status ">{data.max_amount}</span>
                                                                        </div>
