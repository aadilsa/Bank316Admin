...
import { AllCustomData } from '../../API/AllTransactionApi.js/AllTranasaction'
...
export const AllCustom = () => {
    ...
    const GetAllCurrencyData = async () => {
        ...
        try {
            const totaldata = await AllCustomData(token, sortedBy, orderBy, search, pageNumber)
            console.log(totaldata, "daatatta")
    ...
    console.log(sortedBy, orderBy, "OOOOOOOOOOOO")
    return (
        <Container>
                                ...
                                <div className="nk-block-between">
                                    <div className="nk-block-head-content">
                                        ...
                                        <div className="nk-block-des text-soft">
                                            <p>You have total <span className='fw-bold'>({count})</span> Custom Transaction.</p>
                                        </div>
                                            ...
                                            <>
                                                {
                                                    ...
                                                    <div className="nk-tb-item">
                                                        ...
                                                        <div className="nk-tb-col">      {scroll == false ? <Loader /> : <h6>No Custom Transaction Available</h6>}</div>
                                                                ...
                                                                <div className="nk-tb-item">
                                                                    ...
                                                                    <div className="nk-tb-col tb-col-md">
                                                                        ...
                                                                        <div class="user-card"><div class="user-avatar bg-primary">
                                                                            ...
                                                                            <div class="user-info" style={{ cursor: "pointer" }} onClick={() => GoToUserDetail(data.client_id)}>
